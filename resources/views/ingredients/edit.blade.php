          ...
          <form class="w-full" action="{{ route('ingredients.update', ['ingredient' => $item->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input value="{{ old('types') ?? $item->types }}" name="types" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Ingredients Types">
                            <p class="text-gray-600 text-xs italic">Example: recomended, popular, new..Ingredients</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
